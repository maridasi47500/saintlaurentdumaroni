        ...
        function push_event_ctr(format, type){
            ...
            smile_img_1.src = 'https://stats2.smilewanted.com/stats_click/pixel.php?format='+format+'&domaine=megazap_fr_8b1bb31&type='+type;
            
            if(type == 'impression'){
                var smile_img_2 = create_pixel_ad_smilewanted();
                smile_img_2.src = 'https://prebid.smilewanted.com/track/analytics/impression.php?id_site=10355&id_format=3&id_device=3&code_partner=smart';
            }
        }
        ...
        script_sw_inter_natif_face_front.addEventListener('click', function(event){
            ...
            if(!first_click){
                ...
                ga('smile_interstitiel.send', 'event', 'Click Crea', 'megazap_fr_8b1bb31', 'Smart - Mobile Interstitial Native');
        ...
        document.getElementById("inter_sw_native_cta").addEventListener('click', function(event){
            document.getElementById('sw_inter_natif').remove();
            ga('smile_interstitiel.send', 'event', 'Click Bouton CTA', 'megazap_fr_8b1bb31', 'Smart - Mobile Interstitial Native');
        });
        ...
        if(if_show_ad_inter("sw_inter", 0)){
            ...
            if(isMobile){
                ...
                sas.cmd.push(
                    function(){
                        sas.call({
                                ...
                                formatId: 58811,
                                tagId: "sw_inter_crea",
                                target: "type_integration=interstitiel"
                            }, {
                                networkId: 2491,
                                ...
                                onAd: function(data){
                                    ...
                                    ga('smile_interstitiel.send', 'event', 'Impressions Inter', 'megazap_fr_8b1bb31', 'Smart - Mobile Interstitial 1st Page');
                                        ...
                                        function(){
                                            sas.call({
                                                ...
                                                onAd: function(data){
                                                    ...
                                                    document.getElementById("sw_inter").style.visibility = 'visible';
                                                    increment_cookie_inter("sw_inter");
                                                    ga('smile_interstitiel.send', 'event', 'Impressions Inter', 'megazap_fr_8b1bb31', 'Smart - Mobile Interstitial 2nd Page');
                                                            ...
                                                            function(){
                                                                sas.call({
                                                                    ...
                                                                    onAd: function(data){
                                                                        ...
                                                                        increment_cookie_inter("sw_inter");
                                                                        ga('smile_interstitiel.send', 'event', 'Impressions Inter', 'megazap_fr_8b1bb31', 'Smart - Mobile Interstitial V');
                                                                                ...
                                                                                function(){
                                                                                    sas.call({
                                                                                            ...
                                                                                            onAd: function(data){
                                                                                                ...
                                                                                                document.getElementById("sw_inter").style.visibility = 'visible';
                                                                                                increment_cookie_inter("sw_inter");
                                                                                                ga('smile_interstitiel.send', 'event', 'Impressions Inter', 'megazap_fr_8b1bb31', 'Smart - Mobile Pop');
                                                                                                    ...
                                                                                                    function(){
                                                                                                        sas.call({
                                                                                                                ...
                                                                                                                onAd: function(data){
                                                                                                                    ...
                                                                                                                    document.getElementById("sw_inter").style.visibility = 'visible';
                                                                                                                    increment_cookie_inter("sw_inter");
                                                                                                                    ga('smile_interstitiel.send', 'event', 'Impressions Inter', 'megazap_fr_8b1bb31', 'Smart - Mobile Pop 2');
                                                                            ...
                                                                            function check_ready_inter_native(){
                                                                                if(document.getElementById("sw_native_values")){
                                                                                    ...
                                                                                    if(sw_native_img && sw_native_click){
                                                                                        ...
                                                                                        ga('smile_interstitiel.send', 'event', 'Impressions Inter', 'megazap_fr_8b1bb31', 'Smart - Mobile Interstitial Native');
                                                                                    ...
                                                                                    if(passback_inter_native){
                                                                                        sw_execute_passback("");
                                                                                        top.ga('smile_interstitiel.send', 'event', 'Passback Inter', 'megazap_fr_8b1bb31', 'Cascade');
                                                                                    }else{
                ...
                sw_execute_passback("");
                top.ga('smile_interstitiel.send', 'event', 'Passback Inter', 'megazap_fr_8b1bb31', 'Desktop');
            }
        }else{
            sw_execute_passback("");
            top.ga('smile_interstitiel.send', 'event', 'Capping Inter', 'megazap_fr_8b1bb31', 0);
            top.ga('smile_interstitiel.send', 'event', 'Passback Inter', 'megazap_fr_8b1bb31', 'Capping');
        }
